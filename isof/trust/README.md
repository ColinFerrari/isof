# Certificats de confiance IsoFind

Ce dossier contient les certificats CA embarqués pour la vérification
...
# IsoFind Trust Certificates

This folder contains the embedded CA certificates for offline verification of Layer 2 signatures (IsoFind PKI).
